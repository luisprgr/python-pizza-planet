...
class ServiceBuilder:
    ...
    def build(cls):
        ...
        cls.result.add_url_rule('/', methods=['POST'], view_func=cls.build_create_method)
        cls.result.add_url_rule('/<_id>', methods=['PUT'], view_func=cls.build_update_method)
        cls.result.add_url_rule('/id/<_id>', methods=['GET'], view_func=cls.build_get_by_id_method)
        cls.result.add_url_rule('/', methods=['GET'], view_func=cls.build_get_all_method)
        return cls.result
